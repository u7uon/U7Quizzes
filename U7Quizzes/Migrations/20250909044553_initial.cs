        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizCategory_Category_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Category",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuizCategory_Quiz_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quiz",
                        principalColumn: "QuizId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    QuizTagId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QuizId = table.Column<int>(type: "int", nullable: false),
                    TagId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizTag", x => x.QuizTagId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Session_AspNetUsers_HostId",
                        column: x => x.HostId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Session_Quiz_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quiz",
                        principalColumn: "QuizId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionStatistics = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionReport", x => x.ReportId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Response_Participant_ParticipantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorite_QuizId",
                table: "Favorite",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_Favorite_UserId_QuizId",
                table: "Favorite",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizCategory_CategoryId",
                table: "QuizCategory",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizCategory_QuizId_CategoryId",
                table: "QuizCategory",
                columns: new[] { "QuizId", "CategoryId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_QuizTag_QuizId_TagId",
                table: "QuizTag",
                columns: new[] { "QuizId", "TagId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Response_ParticipantId",
                table: "Response",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Session_HostId",
                table: "Session",
                column: "HostId");

            migrationBuilder.CreateIndex(
                name: "IX_Session_QuizId",
                table: "Session",
                column: "QuizId");
